...
const CourseHero = () => {
  return (
    <section className="bg-primary text-white overflow-hidden">
      ...
      {/* Main Hero Content */}
      <div className="">
        <div className="flex flex-col  p-2 pl-8 md:flex-row items-center shadow-2xl shadow-black/50 overflow-hidden relative">
          <video
            autoPlay
            loop
            muted
          ...
          <div className="w-full md:w-3/4 flex flex-col items-center text-center gap-6 py-4 md:py-0 relative z-10">
            <div className="relative z-10 w-full flex flex-col items-center gap-6">
              ...
              <div className="w-full bg-secondary/80 py-6 border-y border-orange-500/10 relative backdrop-blur-sm">
                ...
                <p className="text-xl md:text-2xl text-[#ffbbdf] font-serif tracking-tight mb-2">
                  Join Our Certified KP Astrology Courses –{" "}
                  <span className="not-italic  text-white tracking-tight">
                    Online & Offline
                  </span>
                </p>
                <p className="text-orange-300 text-lg font-medium font-amaranath tracking-tight ">
      ...
      <div className="relative  ">
        <div className="bg-linear-to-r from-black via-secondary to-black py-6 rounded-b-[100%] border-b-4 border-orange-500 shadow-[0_4px_20px_rgba(255,165,0,0.3)]">
          <div className="container mx-auto px-4 text-center">
            <h3 className="text-2xl md:text-4xl text-orange-500 font-bold font-amaranath tracking-wider">
